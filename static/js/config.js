...
export const defaultConfig = {
    ...
    messageSent: false,
    speechMetadata: [],
    SILENCE_THRESHOLD: 60000 // 1 minute silence threshold
};
...
export const testPrompts = {
    ...
    part2: {
        intro: "I'm going to give you a topic and I'd like you to talk about it for 1 to 2 minutes. Before you start, you'll have one minute to prepare. Here's some paper and a pencil for making notes.",
        topics: [
